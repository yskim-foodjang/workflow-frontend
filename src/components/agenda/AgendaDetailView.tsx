      ...
      <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
        ...
        <div>
          ...
          <dd className="text-slate-900 dark:text-white font-medium">
            {format(new Date(agenda.startAt), 'yyyy.M.d (EEE) HH:mm', { locale: ko })}
          </dd>
        </div>
        {agenda.endAt && (
          <div>
            ...
            <dd className="text-slate-900 dark:text-white font-medium">
              {format(new Date(agenda.endAt), 'yyyy.M.d (EEE) HH:mm', { locale: ko })}
            </dd>
          </div>
        )}
        {agenda.deadline && (
          <div>
            ...
            <dd className={clsx('font-medium', {
              ...
              {format(new Date(agenda.deadline), 'yyyy.M.d (EEE) HH:mm', { locale: ko })}
